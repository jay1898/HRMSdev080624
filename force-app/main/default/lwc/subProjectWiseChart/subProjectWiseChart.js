...
import getSubProjectWise from '@salesforce/apex/SubProjectWiseController.getSubProjectWise';

export default class SubProjectWiseChart extends LightningElement {
    chart;
    ...
    @wire(getSubProjectWise)
    Timesheets({ error, data }) {
        if (data) {
            console.log('Data getSubProjectWise----------->' + data);
