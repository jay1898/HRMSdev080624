...
export default class LoginPage extends LightningElement {
    ...
    reportsheetClick = false;
    skillMatrixClick = false;
    ...
    handleRedirect(event){
        ...
        this.actionClick = !event.detail.value;
            ...
            this.isLoading = false;
            this.reportsheetClick = false;
            this.skillMatrixClick = false;
    }
    ...
    handleLeftPanelButtonClick(event){
        ...
        if(event.detail.actionbutton == 'reportsheet'){
            //console.log('log in reportsheet');
            this.actionClick = !event.detail.value;
            this.reportsheetClick = event.detail.value;
            this.requestDetailsClick = false;
            this.requesReportClick = false;
            this.dashboardClick = false;
            this.ticketHistoryClick = false;
        ...
        if(event.detail.actionbutton == 'skillMatrix'){
            //console.log('log in reportsheet');
            this.actionClick = !event.detail.value;
            this.skillMatrixClick = event.detail.value;
            this.requestDetailsClick = false;
            this.requesReportClick = false;
            this.dashboardClick = false;
            this.ticketHistoryClick = false;
